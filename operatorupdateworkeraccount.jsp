...
<html>
    ...
    <body>
        ...
        <div class="container" style="width:1500px;height:630px;background-image:url('images/adminpage.jpg');
            ...
            <div class="row">
                <div class="center"> 
                    <form class="formcode" action="adminupdateworkeraccountcode.jsp">
                        <table style="width:100%;height: 100%" cellspacing='30' cellpadding='10'>
                            ...
                            <tr align='center'>
                                ...
                                <td><input type='text' name="type" placeholder="enter worker Type" class='texttheme'></td>
                                <td>Available Time</td>
                                <td><input type='text' name="time" placeholder="enter  Available Time" class='texttheme'></td>
                            </tr>
                            <tr align='center'>
                                <td>Experience</td>
                                <td><input type='text' name="experience" placeholder="enter Experience" class='texttheme'></td>
                                <td>Salary</td>
